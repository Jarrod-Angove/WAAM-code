...
for file in files 
    ...
    # Making the time start from 0 and formatting the number
    ...
    anim = @animate for i in 1:length(df.temps) 
        ...
        Plots.heatmap(df.heatmap[i], clims = (25, tmax+5), title = "$nm Thermocouple Heatmap",
...
# I think this is working but It's refusing to run on my mac. I'll try it on a linux machine when I get home.
