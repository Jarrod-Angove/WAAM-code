...
# ╔═╡ f10f30eb-d19d-492b-901c-6588ffd44258
# Heat transfer efficiency based on "80-90%" from lienertTransferHeatMass2011
const η = 0.85
...
scrubbed = select(dropmissing(expanddf, [:name, :powerfile, :range, :ttsms]), "name", "powerfile", "range", "ttsms")
...
known_points = dropmissing(combinedf, [:name, :powerfile, :range, :ttsms])
...
julia_version = "1.8.2"
manifest_format = "2.0"
project_hash = "b8f86bd1e9c4aee82ba53e46305fe8559e470577"
